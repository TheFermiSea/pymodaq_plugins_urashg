...
def mock_newport_controller():
    ...
    with patch('pymodaq_plugins_urashg.hardware.urashg.newport1830c_controller.Newport1830CController') as mock_controller:
...
def test_ini_detector(newport_plugin):
    ...
    newport_plugin.settings.child('connection_group', 'serial_port').setValue('/dev/ttyS0')
