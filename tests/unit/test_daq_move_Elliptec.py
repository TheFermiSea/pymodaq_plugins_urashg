...
def mock_elliptec_controller():
    ...
    with patch('pymodaq_plugins_urashg.hardware.urashg.elliptec_wrapper.ElliptecController') as mock_controller:
...
def test_ini_stage(elliptec_plugin):
    ...
    elliptec_plugin.settings.child('connection_group', 'serial_port').setValue('/dev/ttyUSB0')
