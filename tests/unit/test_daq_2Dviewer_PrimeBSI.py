...
def mock_pyvcam():
    ...
    with patch('pymodaq_plugins_urashg.daq_viewer_plugins.plugins_2D.daq_2Dviewer_PrimeBSI.pvc') as mock_pvc,         patch('pymodaq_plugins_urashg.daq_viewer_plugins.plugins_2D.daq_2Dviewer_PrimeBSI.Camera') as mock_camera:
