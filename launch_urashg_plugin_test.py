...
def test_individual_plugins():
    ...
    try:
        ...
        try:
            from src.pymodaq_plugins_urashg.daq_move_plugins.daq_move_Elliptec import DAQ_Move_Elliptec
            ...
            plugin.settings.child('connection_group', 'mount_addresses').setValue('2,3,8')
        ...
        try:
            from src.pymodaq_plugins_urashg.daq_move_plugins.daq_move_MaiTai import DAQ_Move_MaiTai
        ...
        try:
            from src.pymodaq_plugins_urashg.daq_viewer_plugins.plugins_2D.daq_2Dviewer_PrimeBSI import DAQ_2DViewer_PrimeBSI
            test_results.append("✅ DAQ_2DViewer_PrimeBSI: Import successful")
            
            # Note: Camera plugin might need more complex initialization
            test_results.append("ℹ️  DAQ_2DViewer_PrimeBSI: Requires PyVCAM for full testing")
        ...
        try:
            from src.pymodaq_plugins_urashg.daq_viewer_plugins.plugins_0D.daq_0Dviewer_Newport1830C import DAQ_0DViewer_Newport1830C
            test_results.append("✅ DAQ_0DViewer_Newport1830C: Import successful")
            
            plugin = DAQ_0DViewer_Newport1830C(None, None)
            plugin.settings.child('connection_group', 'mock_mode').setValue(True)
            test_results.append("✅ DAQ_0DViewer_Newport1830C: Instance created successfully")
        ...
        try:
            from src.pymodaq_plugins_urashg.hardware.urashg.elliptec_wrapper import ElliptecController
