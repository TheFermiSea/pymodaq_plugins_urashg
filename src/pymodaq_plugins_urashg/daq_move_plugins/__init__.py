...
This module contains all DAQ_Move plugins for controlling actuators
in the URASHG microscope system:
...
Each plugin inherits from DAQ_Move_base and implements the standard
PyMoDAQ actuator interface
